...
class Peract2Inputs(transforms.DataTransformFn):
    """
    ...
    def __call__(self, data: dict) -> dict:
        ...
        wrist_left_image = _parse_image(data["observation/wrist_left_image"])
...
@dataclasses.dataclass(frozen=True)
class Peract2Outputs(transforms.DataTransformFn):
    """
